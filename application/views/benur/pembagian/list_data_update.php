			...
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						...
						<button class="btn  btn-sm btn-danger" onclick="PopupCenter('<?php echo base_url('benur/pembagian/print/'.$data.'/'.$data_kode->id); ?>', 'myPop1',720,450)" >Print</button>
						<button class="btn btn-sm btn-success" onclick="PopupCenter('<?php echo base_url('benur/pembagian/print_surat_jalan/'.$data_kode->id); ?>', 'myPop1',720,450)" >Print Surat Jalan</button>
						...
						<form method="POST" id="form-kode-benur" action="<?php echo base_url('/benur/pembagian/form_add_kode/'); ?>">
								...
								<input type="hidden" name="id" value="<?php echo $data_kode->id; ?>">
									...
									<div class="row">
										<div class="col-sm-1">
											<div class="form-group">
												...
												<input type="text" class="form-control form-control-sm" placeholder="Kode Benur" name="kode" id="kode" aria-describedby="sizing-addon2" value="<?php echo $data_kode->kode; ?>" required>
											</div>
										</div>
										<div class="col-sm-1">
											<div class="form-group">
												<label for="Kode">PL</label>
												<input type="text" class="form-control form-control-sm" placeholder="PL Benur" name="pl" id="pl" aria-describedby="sizing-addon2" value="<?php echo $data_kode->pl; ?>" required>
											</div>
										</div>
										<div class="col-sm-1">
											<div class="form-group">
												<label for="Kode">BOX</label>
												<input type="text" class="form-control form-control-sm" placeholder="Box" name="box" id="box" aria-describedby="sizing-addon2" value="<?php echo $data_kode->box; ?>" required>
											</div>
										</div>
										<div class="col-sm-1">
											<div class="form-group">
												<label for="Kode">Perbox</label>
												<input type="text" class="form-control form-control-sm" placeholder="Perbox" name="perbox" id="perbox" aria-describedby="sizing-addon2" value="<?php echo $data_kode->perbox; ?>" required>
											</div>
										</div>
										<div class="col-sm-2">
											<div class="form-group">
												<label for="Kode">Total Kantong</label>
												<input type="text" class="form-control form-control-sm" placeholder="Total Kantong" name="total_kantong" id="total_kantong" aria-describedby="sizing-addon2" value="<?php echo $data_kode->total_kantong; ?>" required>
											</div>
										</div>
									</div>
								...
								<div class="row fixed-menu">
									...
									<div id="fixed-menu-1" class="col-sm-2">
											<div class="form-group">
												<label for="Alamat">Perkantong</label>
												<input type="text" class="form-control form-control-sm" placeholder="Isi Kantong" name="perkantong_kirim" id="perkantong_kirim" aria-describedby="sizing-addon2" value="<?php echo angka_indo($data_kode->perkantong); ?>" onkeyup="sum_selisih(); ribuan_ketik('perkantong_kirim');" required>
											</div>
									</div>
									<div id="fixed-menu-2" class="col-sm-2">
											<div class="form-group">
												<label for="Alamat">Stok tersedia</label>
												<input type="text" class="form-control form-control-sm" placeholder="Stok dari BLK" name="stok" id="stok" aria-describedby="sizing-addon2" value="<?php echo angka_indo($data_kode->stok_tersedia); ?>" onkeyup="sum_selisih(); ribuan_ketik('stok');" required>
											</div>
									</div>
									<div id="fixed-menu-3" class="col-sm-2">
											<div class="form-group">
												<label for="Alamat">Stok Kebutuhan</label>
												<input type="text" class="form-control form-control-sm" placeholder="Stok Kebutuhan" name="kebutuhan" id="kebutuhan" aria-describedby="sizing-addon2" value="<?php echo angka_indo($total_benur->jmlBenurKirim); ?>" onkeyup="sum_selisih(); ribuan_ketik('kebutuhan');" required>
											</div>
									</div>
									<div id="fixed-menu-4" class="col-sm-2">
											<div class="form-group">
												<label for="Alamat">Selisih</label>
												<input type="text" class="form-control form-control-sm" placeholder="Stok Kebutuhan" name="selisih" id="selisih" aria-describedby="sizing-addon2" value="<?php echo angka_indo($data_kode->selisih); ?>" required>
											</div>
									</div>
									<div id="fixed-menu-5" class="col-sm-2">
										<label for="Alamat">Selisih Ktg</label>
											<div class="form-group">
												<input type="text" class="form-control form-control-sm" placeholder="Stok Kebutuhan" name="selisihKantong" id="selisihKantong" aria-describedby="sizing-addon2" value="<?php echo $data_kode->selisih_kantong; ?>" required >
											</div>
									</div>
	...
	<div class="modal" id="custom-kantong" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="POST" action="<?php echo base_url('/benur/pembagian/batch_update_kantong/'.$jnsBnr.'/'.$data_kode->id); ?>">
					<div class="input-group form-group">
						<span class="input-group-addon" id="sizing-addon2">
							<i class="glyphicon glyphicon-user"></i>
						</span>
						<input type="text" class="form-control form-control-sm" placeholder="Jumlah Benur Perkantong" name="perkantong_kirim_batch" aria-describedby="sizing-addon2" value="<?php echo angka_indo($data_kode->perkantong); ?>" required>
					</div>
